...
namespace RocketNewsAPI.Components
{
    public class Scheduler : SchedulerInterface
    {
        ...
        public override void DoWork()
        {
            ...
            {
                var portalCatalog = new PortalCatalogLimpet(portalId, DNNrocketUtils.GetCurrentCulture(), "rocketnewsapi");
                ...
                {
                    if (portalCatalog.DebugMode) LogUtils.LogSystem("RocketNewsAPI Scheduler not run, LastSchedulerTime: " + portalCatalog.LastSchedulerTime.ToString("O") + " CurrentTime: " + DateTime.Now.ToString("O"));
                }
            }
        }
    }
